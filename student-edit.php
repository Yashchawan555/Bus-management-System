          ...
          <div class="row">
               <div class="col-md-12">
                    <div class="card">
                         ...
                         <h4>Student Update<a href="admin.php" class="btn btn-danger float-end">BACK</a></h4>
                         </div>
                         <div class="card-body">
                                   ...
                                   if (mysqli_num_rows($qurey_run)> 0) {
                                        ...
                                        <form action="backend_code.php" method="POST">
                                             ...
                                             <div class="md-3 mt-4">
                                                  ...
                                                  <input type="text" value="<?= $student['student_name']; ?>" name="add_student_name" class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <label>Student Registration Number:</label>
                                                  <input type="text" value="<?= $student['registration_number']; ?>" name="add_student_email" placeholder="Start with Capital EN e.g. EN20168758" class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <label>Student Phone:</label>
                                                  <input type="text" value="<?= $student['phone']; ?>" name="add_student_phone" class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <label>Student Location:</label>
                                                  <input type="text" value="<?= $student['location']; ?>" name="add_student_location" class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <label>Student Stop:</label>
                                                  <input type="text" value="<?= $student['stop']; ?>" name="add_student_stop" class="form-control">
                                             </div>
                                             ...
                                             <div class="md-3 mt-4">
                                                  ...
                                                  <input type="date" name="date_of_fees_paid" value="<?= $student['date_of_fees_paid']; ?>" class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <label>Next Date To Pay Fees:</label>
                                                  <input type="date" name="next_date_to_pay_fees" value="<?= $student['next_date_to_pay_fees']; ?>" class="form-control">
                                             </div>

                                             <div class="md-3 mt-4">
                                                  <!-- <button type="reset" class="btn btn-primary mx-2">Reset</button> -->
                                                  <button type="submit" name="update_student" class="btn btn-primary mx-2">Update Student</button>
                                             </div>
