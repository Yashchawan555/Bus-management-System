                         ...
                         <div class="card-body">
                              <form action="backend_code.php" method="POST">
                                   ...
                                   <div class="md-3 mt-4">
                                        ...
                                        <input type="text" name="add_student_name" class="form-control">
                                   </div>

                                   <div class="md-3 mt-4">
                                        <label>Student Registration Number:</label>
                                        <input type="text" name="add_student_email" placeholder="Start with Capital EN e.g. EN20168758" class="form-control">
                                   </div>

                                   <div class="md-3 mt-4">
                                        <label>Student Phone:</label>
                                        <input type="text" name="add_student_phone" class="form-control">
                                   </div>

                                   <div class="md-3 mt-4">
                                        <label>Student Location:</label>
                                        <input type="text" name="add_student_location" class="form-control">
                                   </div>

                                   <div class="md-3 mt-4">
                                        <label>Student Stop:</label>
                                        <input type="text" name="add_student_stop" class="form-control">
                                   </div>
