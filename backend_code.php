...
if ($con->connect_error) {
     ...
     // Update Student Record
          ...
          if ($query_run) {
               ...
               try {
                    ...
                    $email_template = "
                    <h2>Welcome to Bus Management Portal</h2>
                    <h4>You are receiving this email because we have update your information. Kindly login and check your information.</h4>
                    <br>
                    <i>Thank You!</i>
                    ";
     ...
     // Password Reset Code
     else if (isset($_POST['password_reset_link'])) {
