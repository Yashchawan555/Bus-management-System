...
<body>
     <div class="container mt-5 mb-5 p-0">
          ...
          <a href="admin-edit.php" name="admin_edit_btn" class="btn btn-success float-end mx-2">Admin Edit</a>
          </h3>
          <!-- </div> -->
               ...
               <div class="col-md-12">
                    <div class="card p-0">
                         <div class="card-header">
                              <h4>Student Details:
                                  <a href="student_create_page.php" class="btn btn-primary float-end">Add Student</a>
                              </h4>
                         </div>
